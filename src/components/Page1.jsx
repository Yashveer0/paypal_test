        ...
        <>
            <section className='flex items-center    justify-center flex-col  text-[.6rem] md:text-[1rem] '>
                ...
                <div className='  md:w-[100%] min-w-[100%] md:p-[6rem] p-[2rem] md:mt-[2rem] mt-[1rem]'>
                    <img className='md:w-[500px] w-[100px]  drop-shadow-lg md:min-h-[370px] min-h-[160px] ' src={img3} alt="" />


                    <img className=' md:w-[500px] w-[100px] md:min-h-[400px] min-h-[180px] drop-shadow-lg  absolute md:top-[36rem] top-[20rem] md:left-[25rem] left-[8rem] md:rounded-[1rem] rounded-[.6rem]' src={img2} alt="" />

                     <img className=' md:w-[500px] w-[100px]  md:min-h-[400px] min-h-[180px] drop-shadow-lg   absolute md:top-[36rem] top-[20rem] md:left-[45rem] left-[13rem] rounded-[1rem]' src={img1} alt="" />
